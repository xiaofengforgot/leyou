...
public class SearchService {
    ...
    /**
     * 将spu转化为goods对象,因为是通过feign查询其他服务接口返回的json数据，然后需要把这些数据封装给
     *
     * @param spu
     * @return
     * @throws IOException
